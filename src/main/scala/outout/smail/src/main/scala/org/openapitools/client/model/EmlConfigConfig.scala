...
case class EmlConfigConfig (
  defaultAddress: Option[String] = None,
  defaultDomain: Option[String] = None,
  defaultSender: Option[String] = None,
  defaultRecipient: Option[String] = None,
  domainConfigs: OneOfImportToDomainConfig2ImportToSystemConfig2,
