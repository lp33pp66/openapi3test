...
case class DeliveryConfig (
  ...
  bouncePrefix: Option[String] = None,
  bounceAttachment: Option[String] = None,
  bounceMessage: Option[String] = None,
  deliverSettings: Option[Map[String, DeliverySetting]] = None
) extends ApiModel
