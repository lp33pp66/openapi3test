...
case class ScopedPreference (
  value: Option[Any] = None,
  scope: Option[ScopedPreferenceEnums.Scope] = None,
  resolution: Option[ScopedPreferenceEnums.Resolution] = None
) extends ApiModel

object ScopedPreferenceEnums {
