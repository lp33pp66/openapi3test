...
public class UserApi {
     ...
     */
    public okhttp3.Call updateUserCall(User body, String username, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateUserValidateBeforeCall(User body, String username, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateUserCall(body, username, _callback);
        return localVarCall;
    ...
    public ApiResponse<Void> updateUserWithHttpInfo(User body, String username) throws ApiException {
        okhttp3.Call localVarCall = updateUserValidateBeforeCall(body, username, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call updateUserAsync(User body, String username, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateUserValidateBeforeCall(body, username, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
